...
#
str_sub(fulldata$pathologic_stage[str_length(fulldata$pathologic_stage) >= 2 & substr(fulldata$pathologic_stage,1,1)=='I'],
str_length(fulldata$pathologic_stage[str_length(fulldata$pathologic_stage) >= 2 & substr(fulldata$pathologic_stage,1,1)=='I']),
str_length(fulldata$pathologic_stage[str_length(fulldata$pathologic_stage) >= 2 & substr(fulldata$pathologic_stage,1,1)=='I'])) <- ''
